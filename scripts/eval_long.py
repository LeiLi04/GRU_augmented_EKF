"""Evaluate long-horizon sequences with the trained GRU-augmented EKF."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Long-horizon evaluation.")
    parser.add_argument(
        "--config",
        type=str,
    ...
    dataset_path = Path(cfg.data.long_test_path or cfg.data.test_path).resolve()
